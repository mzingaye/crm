                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_content">
                        ...
                        <ul class="wizard_steps">
                            ...
                            <hr>
                            <h:commandLink action="viewcatholic.jsp" value="Previous Page" styleClass="btn btn-danger"></h:commandLink>
                            <h:commandLink action="viewbaptism.jsp" value="Next Page" styleClass="btn btn-primary"/>                          
                        </h:form>
                        </div>
                    </div>
                </div>
