<%-- 
    Document   : viewmisc
    Created on : 08 Nov 2017, 7:58:37 PM
    Author     : Hp
--%>
...
<t:mainTemplate>
    ...
    <jsp:attribute name="page_title">View Miscellaneous Record</jsp:attribute>
              ...
              <div class="">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2>Update Miscellaneous Record for ${misc.c.fname} ${misc.c.lname} </h2>
                      ...
                      <div class="x_content">
                        ...
                        <div id="wizard" class="form_wizard wizard_horizontal">
                            ...
                            <hr>
                                ...
                                <hr>
                                <h:commandButton action="#{misc.edit()}" value="Update" styleClass="btn btn-primary"/>
