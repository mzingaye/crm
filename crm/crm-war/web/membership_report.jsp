<%-- 
    Document   : membership_report
    Created on : 09 Nov 2017, 2:30:49 PM
    Author     : Hp
--%>
            ...
            <div style="width:800px; height:1150px; padding:20px;  border: 10px solid #787878;">
                <div style="width:750px; height:1100px; padding:20px; text-align:center; border: 5px solid #787878">
                    <table class="table table-striped" >
                        <tr>
                            <td colspan="2"><br><span style="font-size:50px; font-weight:bold">Membership Certificate</span><br></td>
                        </tr>
                        <tr>
