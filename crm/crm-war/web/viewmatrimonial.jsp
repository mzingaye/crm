                    ...
                    <div class="x_content">
                        ...
                        <h:form styleClass="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Middle Name</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <h:inputText readonly="true" styleClass="form-control has-feedback-left" id="mname" value="#{csBean.mname}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Last Name</label>
                        ...
                        <h:form styleClass="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">First Name</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <h:inputText readonly="true"  styleClass="form-control has-feedback-left" id="fname" value="#{sBean.fname}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Middle Name</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <h:inputText readonly="true" styleClass="form-control has-feedback-left" id="mname" value="#{sBean.mname}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Last Name</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <h:inputText readonly="true" styleClass="form-control has-feedback-left" id="lname" value="#{sBean.lname}"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">National ID / Passport Number</label>
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <h:inputText readonly="true" styleClass="form-control has-feedback-left" id="natID" value="#{sBean.natID}"/>
                                </div>
                            </div>
                            <hr>
                        </h:form>
                        <h:form styleClass="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">First Name</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <h:inputText readonly="true"  styleClass="form-control has-feedback-left" id="fname" value="#{ssBean.fname}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Middle Name</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <h:inputText readonly="true" styleClass="form-control has-feedback-left" id="mname" value="#{ssBean.mname}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Last Name</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <h:inputText readonly="true" styleClass="form-control has-feedback-left" id="lname" value="#{ssBean.lname}"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">National ID / Passport Number</label>
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <h:inputText readonly="true" styleClass="form-control has-feedback-left" id="natID" value="#{ssBean.natID}"/>
                                </div>
                            </div>
                            <hr>
                        </h:form>
                            ...
                            <div class="form-group">
                                ...
                                <hr>
                                <h:commandButton action="#{matrimonial.edit()}" value="Edit Record" styleClass="btn btn-success"/>
                            </h:form>
