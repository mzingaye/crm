<%-- 
    Document   : searchbaptfc
    Created on : Jul 26, 2017, 1:11:22 AM
    Author     : Lyne
--%>
        ...
        <f:view>
         <h:form>
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                      <h2>Search Results by First Communion : <h:outputText value="#{bBean.firstCommunion}" style="color: red"/></h2>
                  ...
                  <div class="x_content">
                    ...
                    <h:dataTable value="#{baptism.getFirstCommunion(bBean.firstCommunion)}" var="item" styleClass="table table-striped">
                        <h:column>
                            <f:facet name="header">
                                <h:outputText value="#"/>
                            </f:facet>
