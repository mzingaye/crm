              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Registry <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="faces/catholics.jsp">Catholic Members</a></li>
                        <li><a href="faces/sponsors.jsp">Catholic Sponsors</a></li>
                        ...
                        <li><a href="faces/misc.jsp">Miscellaneous Records</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-stack-exchange"></i> Reports <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="faces/reports.jsp">Reports Management</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-cog"></i> Settings <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="faces/logs.jsp">System Logs</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="faces/help.jsp">Help</a></li>
